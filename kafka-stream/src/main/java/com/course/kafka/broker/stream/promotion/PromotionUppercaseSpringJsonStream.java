...
public class PromotionUppercaseSpringJsonStream {
  ...
  public KStream<String, PromotionMessage> kstreamPromotionUppercase(StreamsBuilder builder) {
    ...
    sourceStream.print(Printed.<String, PromotionMessage>toSysOut().withLabel("Json Serde Original message"));
    uppercaseStream.print(Printed.<String, PromotionMessage>toSysOut().withLabel("Json Serde Uppercase message"));
