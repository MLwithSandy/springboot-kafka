...
public class PromotionUppercaseCustomJsonStream {
  ...
  public KStream<String, PromotionMessage> kstreamPromotionUppercase(StreamsBuilder builder) {
    ...
    sourceStream.print(Printed.<String, PromotionMessage>toSysOut().withLabel("Custom Json Serde Original message"));
    uppercaseStream.print(Printed.<String, PromotionMessage>toSysOut().withLabel("Custom Json Serde Uppercase message"));
